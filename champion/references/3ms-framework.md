...
This framework is the operator brain the council leans on whenever automation is on the table. Three layers, each one builds on the last. Read it once, refer back as needed.
