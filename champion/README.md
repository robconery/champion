...
| `/champion:mirror` | You, talking to you. No verdict, just clarity and the real motive surfaced. |
...
| `/champion:course` | Course design with the gates run first, because it's a big bandwidth bet. |
