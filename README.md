...
| | `/champion:mirror` | You, talking to you. No verdict, just clarity and the real motive. |
...
| | `/champion:course` | Course design, gates first, because it's a big bandwidth bet. |
